	...
	var Loady = function (element) {
		...
		switch (settings.animation) {
			case "snake":
				...
				html = '<svg xmlns="http://www.w3.org/2000/svg" class="loady-placeholder" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.phColor+'" stroke-width="'+params.strokeWidth+'"><circle cx="50" cy="50" r="'+params.radius+'" fill="none"></circle></svg><svg xmlns="http://www.w3.org/2000/svg" class="loady-path-1" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="285" stroke-dashoffset="286" transform-origin="'+params.origin+'px '+params.origin+'px '+params.orgin+'px"><circle cx="50" cy="50" r="'+params.radius+'" fill="none"></circle></svg>';
				break;
			case "spin":
				params.radius = settings.size == "thicc" ? 40 : 45;
				html = '<svg xmlns="http://www.w3.org/2000/svg" class="loady-placeholder" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.phColor+'" stroke-width="'+params.strokeWidth+'"><circle cx="50" cy="50" r="'+params.radius+'" fill="none"></circle></svg><svg xmlns="http://www.w3.org/2000/svg" class="loady-path-1" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="120" stroke-dashoffset="120" stroke-width="'+params.strokeWidth+'" transform-origin="'+params.origin+'px '+params.origin+'px '+params.orgin+'px"><circle cx="50" cy="50" r="'+params.radius+'" fill="none"></circle></svg>';
				break;
			case "three-spin":
				params.rad1 = settings.size == "thicc" ? 40 : 45;
				params.rad2 = settings.size == "thicc" ? 25 : 30;
				params.rad3 = settings.size == "thicc" ? 10 : 15;
				html = '<svg xmlns="http://www.w3.org/2000/svg" class="loady-path-1" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="286" stroke-dashoffset="71.5" transform-origin="'+params.origin+'px '+params.origin+'px '+params.orgin+'px"><circle cx="50" cy="50" r="'+params.rad1+'" fill="none"></circle></svg><svg xmlns="http://www.w3.org/2000/svg" class="loady-path-2" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="200" stroke-dashoffset="105"><circle cx="50" cy="50" r="'+params.rad2+'" fill="none" transform-origin="'+params.origin+'px '+params.origin+'px '+params.orgin+'px"></circle></svg><svg xmlns="http://www.w3.org/2000/svg" class="loady-path-3" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="100" stroke-dashoffset="75" transform-origin="'+params.origin+'px '+params.origin+'px '+params.orgin+'px"><circle cx="50" cy="50" r="'+params.rad3+'" fill="none"></circle></svg>';
				break;
			case "three-dot":
