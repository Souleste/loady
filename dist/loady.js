	...
	var Loady = function (element) {
		...
		switch (settings.animation) {
			...
			case "three-spin":
				...
				html = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="286" stroke-dashoffset="71.5"><circle class="loady-path-1" cx="50" cy="50" r="'+params.rad1+'" fill="none"></circle></svg><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="200" stroke-dashoffset="105"><circle class="loady-path-2" cx="50" cy="50" r="'+params.rad2+'" fill="none"></circle></svg><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100%" height="100%" stroke="'+params.strokeColor+'" stroke-width="'+params.strokeWidth+'" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="100" stroke-dashoffset="75"><circle class="loady-path-3" cx="50" cy="50" r="'+params.rad3+'" fill="none"></circle></svg>'
				break;
			case "three-dot":
